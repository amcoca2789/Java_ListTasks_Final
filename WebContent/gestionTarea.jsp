...
<%!public boolean inicioSesion(HttpSession session) {
		...
		System.out.println("idUsuarioAtt:" + idUsuarioAtt);
		...
		<div class="calendario-dia" id="dia1">
			...
			<form class="calendario-dia-formulario" id="form-newtarea-dia1"
				...
				<label class="calendario-dia-formulario-label u-label"
					...
					id="caja_descripcion_creacion_dia1_tarea1" /> <label
					class="calendario-dia-formulario-label u-label" for="form-newtarea">Fecha
					Realizacion:</label> <input class="calendario-dia-formulario-input u-input"
					name="caja_fecharealizacion_creacion_dia1_tarea1"
					id="caja_fecharealizacion_creacion_dia1_tarea1" />
			...
			<div class="calendario-dia-botonera" id="dia1-tarea1">
				<ul class="calendario-dia-botonera-lista">
					<li class="calendario-dia-botonera-lista-item"><a href=""
					...
					<li class="calendario-dia-botonera-lista-item"><a href=""
						class="calendario-dia-botonera-lista-item-enlace u-enlace u-boton-sindesarrollar"
						id="btn-sindesarrollar-dia1-tarea1"></a></li>
					<li class="calendario-dia-botonera-lista-item"><a href=""
						class="calendario-dia-botonera-lista-item-enlace u-enlace u-boton-endesarrollo"
						id="btn-endesarrollo-dia1-tarea1"></a></li>
				</ul>
			</div>
			<div class="calendario-dia-tarea">
				<span class="calendario-dia-tarea-descripcion u-span">
					Reuniones o comunicaciones online con amig@s o familiares <a
					class="calendario-dia-tarea-descripcion-enlace u-boton-ediciontarea"
					id="btn-edicion-dia1-tarea1" href="#"></a>
				</span>
			</div>
			<form class="calendario-dia-formulario" id="form-edicion-dia1-tarea1"
				...
				<label class="calendario-dia-formulario-label u-label"
					...
					class="calendario-dia-formulario-input u-input"
					name="caja_descripcion_edicion_dia1_tarea1"
					id="caja_descripcion_edicion_dia1_tarea1" /> <label
					class="calendario-dia-formulario-label u-label"
					for="form-edicion-dia1-tarea1">Fecha Realizacion:</label> <input
					class="calendario-dia-formulario-input u-input"
					name="caja_fecharealizacion_edicion_dia1_tarea1"
					id="caja_fecharealizacion_edicion_dia1_tarea1" />
				<ul class="calendario-dia-formulario-lista">
					<li class="calendario-dia-formulario-lista-item">
						<button class="calendario-dia-formulario-lista-item-boton u-boton"
							id="btn-guardar-dia1-tarea1" type="submit">Guardar</button>
